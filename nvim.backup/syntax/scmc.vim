...
runtime! $VIMRUNTIME/syntax/scheme.vim
...
syn keyword schemeSyntax lambda and or if cond case define let let* letrec define-scmc-global
syn keyword schemeSyntax defun defmacro defkernel return for continue break sizeof sizeof-var stderr stdout typedef condmacro ifmacro ifdefmacro ifndefmacro extern typedef-struct
...
syn keyword schemeFunc char-ready? load transcript-on transcript-off eval eval-scmc-global 
...
syn region	scmcType	start="declare-"hs=e+1 end="[ \t\n)]"he=s-1
syn region	scmcType	start="define-"hs=e+1 end="[ \t\n)]"he=s-1
syn region	scmcType1	start="int" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="size_t" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="ssize_t" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="long" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="double" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="char" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="void" end="[ \t\n)]"he=s-1
syn region	scmcType1	start="float" end="[ \t\n)]"he=s-1
syn region	scmcInclude	start="include" end="[ \t\n)]"he=s-1
syn region	scmcInclude	start="include-fun-defs" end="[ \t\n)]"he=s-1
syn region	scmcInclude	start="input-include" end="[ \t\n)]"he=s-1
syn region	scmcInclude	start="input-scmc" end="[ \t\n)]"he=s-1
syn keyword scmcOperator	+ - * / == > < >= <= neq? shift-l shift-r b-and b-or b-xor b-not
...
hi scmcType ctermfg=cyan guifg=#008800 gui=bold
hi scmcType1 ctermfg=cyan guifg=#008800 gui=bold
hi scmcOperator ctermfg=cyan guifg=#008800
hi scmcInclude ctermfg=cyan guifg=#a020f0

let b:current_syntax = "scheme"

let &cpo = s:cpo_save
unlet s:cpo_save
" so $HOME/.vim/plugin/RainbowParenthsis.vim 
